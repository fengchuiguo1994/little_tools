...
# cat <(zcat ENCFF547MET.bed.gz) <(zcat mm10-blacklist.v2.bed.gz) | cut -f 1-3 | bedtools sort -i - | bedtools merge -i stdin > mm10.blacklist.bed

# wget https://www.encodeproject.org/files/ENCFF356LFX/@@download/ENCFF356LFX.bed.gz
# https://github.com/Boyle-Lab/Blacklist/blob/master/lists/hg38-blacklist.v2.bed.gz
# cat <(zcat ENCFF356LFX.bed.gz) <(zcat hg38-blacklist.v2.bed.gz) | cut -f 1-3 | bedtools sort -i - | bedtools merge -i stdin > hg38.blacklist.bed
