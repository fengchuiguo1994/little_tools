...
args = c("I:\\CSCC\\CSCC-C-Hi-C-project\\result\\RNA\\GOKEGGGSEA\\all.c2n.cf2.fc2.featureCount.DESeq2.txt", "I:\\CSCC\\CSCC-C-Hi-C-project\\result\\RNA\\GOKEGGGSEA\\all.c2n.cf2.fc2.featureCount.DESeq2.GO.pdf")
...
pdf(paste0(args[2],"upgene.bardot.pdf"), width=7, height=10)
...
pdf(paste0(args[2],"upgene.graph.pdf"), width=15, height=10)
b1 = cnetplot(setReadable(upgenekegg, 'org.Hs.eg.db', 'ENTREZID')) + labs(title = "up kegg")
b2 = cnetplot(setReadable(upgenekegg, 'org.Hs.eg.db', 'ENTREZID'), foldChange = upgeneList) + labs(title = "up kegg")
b3 = cnetplot(setReadable(upgenekegg, 'org.Hs.eg.db', 'ENTREZID'), categorySize="pvalue", foldChange = upgeneList) + labs(title = "up kegg")
b4 = cnetplot(setReadable(upgenekegg, 'org.Hs.eg.db', 'ENTREZID'), circular = TRUE, colorEdge = TRUE, foldChange = upgeneList) + labs(title = "up kegg")
b5 = heatplot(setReadable(upgenekegg, 'org.Hs.eg.db', 'ENTREZID'), foldChange = upgeneList) + labs(title = "up kegg")
b6 = emapplot(pairwise_termsim(upgenekegg)) + labs(title = "up kegg")
print(b1)
print(b2)
print(b3)
print(b4)
...
pdf(paste0(args[2],"downgene.bardot.pdf"), width=7, height=10)
...
pdf(paste0(args[2],"downgene.graph.pdf"), width=15, height=10)
b1 = cnetplot(setReadable(downgenekegg, 'org.Hs.eg.db', 'ENTREZID')) + labs(title = "down kegg")
b2 = cnetplot(setReadable(downgenekegg, 'org.Hs.eg.db', 'ENTREZID'), foldChange = downgeneList) + labs(title = "down kegg")
b3 = cnetplot(setReadable(downgenekegg, 'org.Hs.eg.db', 'ENTREZID'), categorySize="pvalue", foldChange = downgeneList) + labs(title = "down kegg")
b4 = cnetplot(setReadable(downgenekegg, 'org.Hs.eg.db', 'ENTREZID'), circular = TRUE, colorEdge = TRUE, foldChange = downgeneList) + labs(title = "down kegg")
b5 = heatplot(setReadable(downgenekegg, 'org.Hs.eg.db', 'ENTREZID'), foldChange = downgeneList) + labs(title = "down kegg")
b6 = emapplot(pairwise_termsim(downgenekegg)) + labs(title = "down kegg")
print(b1)
print(b2)
print(b3)
print(b4)
...
pdf(paste0(args[2],"diffgene.bardot.pdf"), width=7, height=10)
...
pdf(paste0(args[2],"diffgene.graph.pdf"), width=15, height=10)
b1 = cnetplot(setReadable(diffgenekegg, 'org.Hs.eg.db', 'ENTREZID')) + labs(title = "diff kegg")
b2 = cnetplot(setReadable(diffgenekegg, 'org.Hs.eg.db', 'ENTREZID'), foldChange = diffgeneList) + labs(title = "diff kegg")
b3 = cnetplot(setReadable(diffgenekegg, 'org.Hs.eg.db', 'ENTREZID'), categorySize="pvalue", foldChange = diffgeneList) + labs(title = "diff kegg")
b4 = cnetplot(setReadable(diffgenekegg, 'org.Hs.eg.db', 'ENTREZID'), circular = TRUE, colorEdge = TRUE, foldChange = diffgeneList) + labs(title = "diff kegg")
b5 = heatplot(setReadable(diffgenekegg, 'org.Hs.eg.db', 'ENTREZID'), foldChange = diffgeneList) + labs(title = "diff kegg")
b6 = emapplot(pairwise_termsim(diffgenekegg)) + labs(title = "diff kegg")
print(b1)
print(b2)
print(b3)
print(b4)
