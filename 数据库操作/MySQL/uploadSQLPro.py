    ...
    try:
        ...
        for line in fin:
            ...
            if informat in bedset:
                ...
                if informat == "scRNA" or informat == "scATAC" or informat == "singleton":
                    if len(record) == 5:
                        record.append("+")
...
""")
    ...
    parser_add.add_argument('-f', "--format", required=True, choices=["bedgraph","ssbedgraph","loop","scRNA","scATAC","scPET","multi","anno","chromhmm","chrband","bed6","RNAbedgraph","ATACbedgraph", "singleton"] ,help="table format")
